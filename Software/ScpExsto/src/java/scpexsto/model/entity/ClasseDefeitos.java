...
@Entity
@Table(name = "CLASSE_DEFEITOS")
public class ClasseDefeitos implements Serializable {
    ...
    public static List<String> getTiposClasseDefeitos() {
    ...
    public boolean equals(Object obj) {
        ...
        final ClasseDefeitos other = (ClasseDefeitos) obj;
    ...
    public String toString() {
        return "ClasseDefeitos{" + "id=" + id + ", descricao=" + descricao + ", tipo=" + tipo + '}';
    }
}
