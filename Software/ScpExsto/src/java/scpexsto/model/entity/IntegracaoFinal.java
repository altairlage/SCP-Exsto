 ...
 */
@Entity
@Table(name = "INTEGRACAO_FINAL")
public class IntegracaoFinal implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        final IntegracaoFinal other = (IntegracaoFinal) obj;
    ...
    public String toString() {
        return "IntegracaoFinal{" + "id=" + id + ", dataInicio=" + dataInicio + ", dataFim=" + dataFim + ", qtdReprocesso=" + qtdReprocesso + ", usuario=" + usuario + '}';
    }
